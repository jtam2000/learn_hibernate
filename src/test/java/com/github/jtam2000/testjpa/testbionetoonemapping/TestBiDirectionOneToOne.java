package com.github.jtam2000.testjpa.testbionetoonemapping;

import com.github.jtam2000.jpa.dao.JPADataAccessDaoImpl;

import com.github.jtam2000.jpa.relationships.bidirectiononetoone.BiInvestmentAccount;
import com.github.jtam2000.jpa.relationships.bidirectiononetoone.BiInvestmentUser;
...
public class TestBiDirectionOneToOne {
    @Test
    public void test_BiDirectionalOneToOne() {

        System.out.println("testing BiDirectional one to one");
    }


    private static final double ASSERT_DOUBLE_TOLERANCE = 0.0001;
    @SuppressWarnings("FieldCanBeLocal")
    private final String jPUString = "jpu_bidirectional_one_to_one";
